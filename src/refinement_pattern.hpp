...
namespace pyoomph
{
  ...
  // The heterogeneous "red" split of a pyramid: 10 children = 6 sub-pyramids (son 0..5) + 4 tetrahedra
  ...
  public:
    unsigned nsons(const BulkElementBase *parent) const override;
    BulkElementBase *construct_son(const BulkElementBase *parent, unsigned ison) const override;
    std::string name() const override { return "pyramid_mixed"; }

    static const PyramidMixedRefinementPattern *instance();
  };
}
