...
void PyReg_Mesh(py::module &m)
{
	...
	decl_PyoomphMesh
		...
		.def("_pin_noncontributing_dofs", &pyoomph::Mesh::pin_noncontributing_dofs)
...
*/
	...
	py::class_<pyoomph::MeshTemplate, pyoomph::PyMeshTemplateTrampoline>(m, "MeshTemplate")
		...
		.def("add_nodes_to_boundary", [](pyoomph::MeshTemplate & self, const std::string &boundname, const std::vector<pyoomph::nodeindex_t> &ni){ throw_runtime_error("add_nodes_to_boundary is deprecated. Use add_facet_to_boundary instead"); })
		.def("add_facet_to_curve_entity",[](pyoomph::MeshTemplate & self, const std::vector<pyoomph::nodeindex_t> &ni, pyoomph::MeshTemplateCurvedEntity *curved=nullptr){ throw_runtime_error("add_facet_to_curve_entity is deprecated. Use add_facet_to_boundary instead"); })
