...
//      oomph_info << "Created Time with " << ndt << " timesteps" << std::endl; // FOR PYOOMPH: Do not disturb here
    }
    else
    {
      ...
      {
        Time_pt->resize(ndt);
        //oomph_info << "Resized Time to include " << ndt << " timesteps" // FOR PYOOMPH: Do not disturb here
//                   << std::endl;
      }
      // Otherwise report that we are OK
      else
      {
        //oomph_info << "Time object already has storage for " << ndt // FOR PYOOMPH: Do not disturb here
        //           << " timesteps" << std::endl;
      }
    }
      ...
      do
      {
        ...
        *parameter_pt = Parameter_current + Parameter_derivative * Ds_current;
        ...
        catch (NewtonSolverError& error)
        {
          ...
          {
//            oomph_info << "STEP REJECTED --- TRYING AGAIN" << std::endl;//FOR PYOOMPH: Output current Ds
            STEP_REJECTED = true;
