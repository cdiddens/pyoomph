...
namespace oomph
{
  ...
  public:
    ...
    //FOR PYOOMPH: Allow to skip init calls by a flag
    QuadTreeForest(Vector<TreeRoot*>& trees_pt,bool skip_init_call=false); ;
    ...
    virtual void check_all_neighbours(DocInfo& doc_info);
  ...
  protected: //FOR PYOOMPH: made protected
    /// Construct the rotation schemes
    //FOR PYOOMPH: made virtual and protected
    virtual void construct_north_equivalents();
