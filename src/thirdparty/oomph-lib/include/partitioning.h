...
/* 
PYOOMPH MODIFICATIONS
# Downloaded this file on 21st May 2026 from oomph-lib's GitHub repository
# Removed the inclusion of "metis.h" and the associated code, as we will use the Python package "pymetis" for partitioning instead of the C library METIS. 
*/
...
// #include "metis.h" //FOR PYOOMPH: Metis is routed through this module->Python->pymetis-> back to here


// FOR PYOOMPH: Metis is routed through this module->Python->pymetis-> back to here
#define idx_t int64_t
#define real_t double
#define METIS_API(type) type
// FOR PYOOMPH: Metis is routed through this module->Python->pymetis-> back to here
// So the options can be defined arbitrarily, it just has to be consistent with what the Python side sends
#define METIS_NOPTIONS 40
#define METIS_OPTION_OBJTYPE 0
#define METIS_OBJTYPE_CUT 0
#define METIS_OBJTYPE_VOL 1
#define METIS_SetDefaultOptions(options) do { for(int i=0;i<METIS_NOPTIONS;i++) options[i]=0; } while(0)
//
