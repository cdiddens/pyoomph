...
# ******************************************+
# MODIFICATIONS ON 27th April, 2023: 
# Added type specifications by Christian Diddens
# ******************************************+
import math, random
from ..typings import *
...
def _make_circle_one_point(points:_Point2dList, p:_Point2d):
	c = (p[0], p[1], 0.0)
...
def _make_circle_two_points(points:_Point2dList, p:_Point2d, q:_Point2d):
...
def make_diameter(a:_Point2d, b:_Point2d)->_CircleDef2d:
	cx = (a[0] + b[0]) / 2
	cy = (a[1] + b[1]) / 2
