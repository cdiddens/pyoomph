...
.. literalinclude:: bifurcation_stationary_transcritical.py
   :language: python
   :start-at: from bifurcation_transient_transcritical import * #Import the equation and problem from the previous script
   :end-at: print(F"Currently, we are at the stationary solution x={xvalue} with r={problem.r.value}")
