...
.. warning::
   ...
   If you do not add any boundary condition on a boundary, i.e. neither a :py:class:`~pyoomph.equations.generic.DirichletBC` nor any additional boundary integral term, there is no additional contribution to the residuals. This is equivalent to setting the Neumann flux to zero, i.e. a no-flux boundary condition.
