...
While it is hard to guarantee that one has found all solutions of a nonlinear problem at a specific parameter, arclength continuation and bifurcation analysis help to find connected branches, by scanning all branches as a function of the parameter and also following new branches emerging e.g. at pitchfork bifurcations, one usually finds the most important stable and unstable solutions.
