...
This tutorial is not intended to be a full reference sheet of all functions pyoomph can offer. However, reading it will gradually guide you through all the important features pyoomph has to offer. Since these capabilities will be introduced where necessary, it is best to read this tutorial completely and try out all the explained capabilities along the course.
