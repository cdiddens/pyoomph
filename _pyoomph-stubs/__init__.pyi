...
class DynamicBulkElementInstance:
    ...
    def has_parameter_contribution(self, arg0: str) -> bool:
        ...
    def link_external_data(self, arg0: str, arg1: OomphData, arg2: int, arg3: str) -> None:
        ...
    def set_analytical_jacobian(self, analytic: bool, analytic_positions: bool) -> None:
        ...
    def setup_interface_dof_indices(self) -> dict[str, int]:
        ...
class Equations:
    def __init__(self) -> None:
        ...
...
class Expression:
    ...
    def __add__(self, arg0: GiNaC_GlobalParam) -> Expression:
        ...
    def __call__(self, **kwargs) -> Expression:
        ...
    ...
    def log(self) -> Expression:
        ...
    def merge_units(self) -> Expression:
        ...
    def nops(self) -> int:
        ...
    ...
    def op(self, arg0: int) -> Expression:
        ...
    def parameters_to_current_values(self) -> Expression:
        ...
...
class GeneralSolverCallback:
    def __init__(self) -> None:
        ...
    def metis_partgraph_kway(self, arg0: int, arg1: int, arg2: numpy.ndarray[numpy.int64], arg3: numpy.ndarray[numpy.int64], arg4: numpy.ndarray[numpy.int64], arg5: int, arg6: numpy.ndarray[numpy.int64], arg7: numpy.ndarray[numpy.int64], arg8: numpy.ndarray[numpy.int64]) -> int:
        ...
...
class InterfaceMesh(Mesh, OomphMesh):
    ...
    def set_opposite_interface_offset_vector(self, arg0: list[float]) -> None:
        ...
    def update_equation_remapping(self) -> None:
        ...
...
class Mesh(OomphMesh):
    ...
    def _pin_all_my_dofs(self, arg0: set[str], arg1: set[str], arg2: set[int]) -> None:
        ...
    def _pin_noncontributing_dofs(self) -> None:
        ...
    ...
    def nrefined(self) -> int:
        ...
    def nroot_halo_element(self) -> int:
        ...
...
class ODEStorageMesh(Mesh, OomphMesh):
    def __init__(self) -> None:
        ...
    def _create_ode_element(self, arg0: TimeStepper) -> OomphGeneralisedElement:
        ...
    def _set_problem(self, arg0: Problem, arg1: typing.Optional[DynamicBulkElementInstance]) -> None:
        ...
class OomphData:
...
class OomphGeneralisedElement:
    ...
    def _debug_hessian(self, arg0: list[float], arg1: list[list[float]], arg2: float) -> None:
        ...
    def _ode_elem_to_numpy(self) -> tuple[numpy.typing.NDArray[numpy.float64], dict[str, int]]:
        ...
    ...
    def eqn_number(self, arg0: int) -> int:
        ...
    def evaluate_local_expression_at_midpoint(self, arg0: int) -> float:
        ...
    def evaluate_local_expression_at_node_index(self, arg0: int, arg1: int) -> float:
        ...
    def evaluate_local_expression_at_s(self, arg0: int, arg1: list[float]) -> float:
        ...
    ...
    def map_nodes_on_macro_element(self) -> None:
        ...
    def must_be_kept_as_halo(self) -> bool:
        ...
    def ncont_interpolated_values(self) -> int:
        ...
    def ndof(self) -> int:
        ...
    ...
    def set_macro_element(self, arg0: MacroElement, arg1: bool) -> None:
        ...
    def set_must_be_kept_as_halo(self, arg0: bool) -> None:
        ...
...
class Problem:
    ...
    def _arc_length_step(self, arg0: str, arg1: float, arg2: int) -> float:
        ...
    def _assemble_defined_field_list(self) -> None:
        ...
    ...
    def _get_bifurcation_omega(self) -> float:
        ...
    def _get_bifurcation_tracking_info(self) -> tuple[bool, complex]:
        ...
    def _get_dof_to_global_field_index_mapping(self) -> list[int]:
        ...
    def _get_global_field_names(self) -> list[str]:
        ...
    def _get_jacobian_information_string(self) -> tuple[str, bool]:
        ...
    ...
    def _set_lambda_tracking_real(self, arg0: float) -> None:
        ...
    def _set_solved_residual(self, name: str, raise_error: bool = True, remove_dofs_without_jacobian_row: bool = True) -> bool:
        ...
    ...
    def _unload_all_dlls(self) -> None:
        ...
    def _unpin_Dirichlet_dofs_for_matrix_manipulation(self) -> None:
        ...
...
class TemplatedMeshBase1d(Mesh, OomphMesh):
    ...
    def setup_tree_forest(self) -> None:
        ...
    def unrefine_uniformly(self, num: int = 1) -> bool:
        ...
